...
export const CompanySupervisorEvaluations: React.FC = () => {
  ...
  return (
    <>
      <PageHead eyebrow="Company Supervisor" title="Evaluations" description="Rate and review your interns' performance." />
      ...
      {selected ? (
        ...
        <div className="card">
          {loading ? (
            ...
            <Empty title="No interns to evaluate" text="Accepted interns will appear here." />
          )}
        </div>
      )}
    </>
